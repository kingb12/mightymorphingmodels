...
function mightymorphingmodels(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.morph_model = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "mightymorphingmodels.morph_model",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "mightymorphingmodels.status",
